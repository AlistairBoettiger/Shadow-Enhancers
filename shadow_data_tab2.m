...
%  % ----------- dadl at 25C Perturbation Data ----------------- %  
%     Data = {      
%         sort( dadl_sog_Neu3(:,5) ); 
%         sort( dadl_sog_Neu3(:,6) );
%         sort( dadl_rho_vnd(:,5) );
%         sort( dadl_rho_vnd(:,6) );
%         sort( dadl_vn_Mes2(:,5) ); 
%         sort( dadl_vn_Mes2(:,6) ); 
...
%    sort( SogS3xdl6_25C(:,3)./SogS3xdl6_25C(:,4) );
%    
%     sort( SogPxYW_22C(:,3)-SogPxYW_22C(:,4) ); 
%    sort( SogPxdl_25C(:,3)-SogPxdl_25C(:,4) ); 
%    sort( SogSxYW_22C(:,3)-SogSxYW_22C(:,4) ); 
...
%  };
%     
% gene_names = {'P YW 22 domain';'P dl 25 domain'; 'S YW 22 domain';'S dl 25 domain'};
...
%         sort(SogS3xdl6_25C(:,5));
%         sort(SogS3xdl6_25C(:,6));
%         sort( SogS3xdl6_25C(:,5)./SogS3xdl6_25C(:,6) );  
%           sort( SogPxYW_22C(:,3)./SogPxYW_22C(:,4) ); 
%    sort( SogPxdl_25C(:,3)./SogPxdl_25C(:,4) ); 
%    sort( SogSxYW_22C(:,3)./SogSxYW_22C(:,4) ); 
%    sort( SogS3xdl6_25C(:,3)./SogS3xdl6_25C(:,4) );
%         };
%    
% gene_names = {'SogPxYW_22C'; 'End YW 22 P'; 'SogPxdl_25C'; 'End dl 25 P';
%     'P-YW:End ratio'; 'P-dl:End ratio'; 'SogSxYW_22C';'End YW S';'S-YW: End ratio';
%     'SogS3xdl6_25C'; 'End dl 25 S' ; 'S-dl:End ratio';
%     'P YW 22 domain';'P dl 25 domain'; 'S YW 22 domain';'S dl 25 domain'};
% %---
% 


% %--%%-----%%----  Stressed Sog Enhancer Analysis ----%%----%%----%%
    Data = {        
        sort( SogPxYW_22C(:,5)./SogPxYW_22C(:,6) ); 
        sort( SogPxdl_25C(:,5)./SogPxdl_25C(:,6) );
...
gene_names = {'sogP Sync'; 'Stressed sogP Sync'; 'sogS Sync';
   'Stressed sogS Sync';'sogP Fidelity';'Stressed sogP Fidelity';
   'sogS Fidelity';'Stressed sogS Fidelity'};
% % ---------%%--------------%%--------------%%---------%%-----------%


figure(2); clf; colordef black; 
x = linspace(0,1,14); 
hist(SogPxYW_22C(:,5),x); hold on;
h =  findobj(gca,'type','patch');
set(h,'FaceColor','r','EdgeColor','none'); 
alpha(.8);
hist(SogPxYW_22C(:,6),x) 
alpha(.8);
xlim([0,1]);
%%
B =  SogPxYW_22C(:,5) ; %SogPxYW_22C(:,5)./SogPxYW_22C(:,6); 
A = SogPxYW_22C(:,6) ; %SogSxYW_22C(:,5)./SogSxYW_22C(:,6);
...
set(gca,'FontSize',15);
legend('Endogenous Sog','SogP>reporter','Location','NorthWest');
